...
import imageTwo from '../../../public/assets/upload_folder/Images/blog-04.jpg';
import imageThree from '../../../public/assets/upload_folder/Images/blog-05a.jpg';
import imageFour from '../../../public/assets/upload_folder/Images/blog-07a.jpg';
import imageFive from '../../../public/assets/upload_folder/Images/god.jpg';
...
export default function ImagesTab () {
  ...
  const emptyRows =
    rowsPerPage -
    Math.min (rowsPerPage, ImagesUpload.length - page * rowsPerPage);
                  ...
                  <div className="file">
                    <div className="fileLogo">
                      <Image
                        width="45"
                        height="55"
                        src={ImagesUploads.fileLogo}
                        alt="imageOne"
                      />
                    </div>
                    <div className="file_desc">
                      <span>{ImagesUploads.fileTitle}</span><br/>
                      <span>{ImagesUploads.fileDescr}</span>
                    </div>
                  </div>
                  <div className="file_archives file_descr_margin_">
                    <span>{ImagesUploads.archiveTitle}</span>
                  </div>
                  <div className="date_time file_descr_margin_">
                    <span>{ImagesUploads.fileDate}</span><br/>
                    <span>{ImagesUploads.fileTime}</span>
                  </div>
