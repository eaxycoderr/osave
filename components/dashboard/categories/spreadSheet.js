...
import xlsxFileLogo from '../../../public/assets/upload_folder/Spreadsheet/xlsx.png';
...
export default function SpreadSheet () {
  ...
  const emptyRows =
    rowsPerPage -
    Math.min (rowsPerPage, spreadSheetUpload.length - page * rowsPerPage);
    ...
    <div className='table'>
                  ...
                  <div className="file">
                    <div className="fileLogo">
                      <Image
                        width="45"
                        height="55"
                        src={spreadSheetUploads.fileLogo}
                        alt="xlsxFileLogo"
                      />
                    </div>
                    <div className="file_desc">
                      <span>{spreadSheetUploads.fileTitle}</span><br/>
                      <span>{spreadSheetUploads.fileDescr}</span>
                    </div>
                  </div>
                  <div className="file_archives file_descr_margin_">
                    <span>{spreadSheetUploads.archiveTitle}</span>
                  </div>
                  <div className="date_time file_descr_margin_">
                    <span>{spreadSheetUploads.fileDate}</span><br/>
                    <span>{spreadSheetUploads.fileTime}</span>
                  </div>
      ...
      <div className="pagination_container">
          <TablePagination
            ...
            component="div"
            count={spreadSheetUpload.length}
            page={page}
