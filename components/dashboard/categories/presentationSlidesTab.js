...
import presentationSlides from '../../../public/assets/upload_folder/PresentationSlides/presentation_slides.png';
...
const presentationSlidesUpload = [
  {
    id: 1,
    fileLogo: presentationSlides,
    fileTitle: 'Resume',
...
export default function PresentationSlidesTab () {
  ...
  const emptyRows =
    rowsPerPage -
    Math.min (rowsPerPage, presentationSlidesUpload.length - page * rowsPerPage);
    ...
    <div className='table'>
      <div className="main_dashboard_contents">
        ...
        <div className="main_dashboard_contents_file">
          {presentationSlidesUpload
            .slice (page * rowsPerPage, page * rowsPerPage + rowsPerPage)
            .map ((presentationSlidesUploads, index) => (
              <div
                className="inn_main_dashboard_contents_file table_contents_padding"
                key={presentationSlidesUploads.key}
              >
                  ...
                  <div className="file">
                    <div className="fileLogo">
                      <Image
                        width="45"
                        height="55"
                        src={presentationSlidesUploads.fileLogo}
                        alt="presentationSlides"
                      />
                    </div>
                    <div className="file_desc">
                      <span>{presentationSlidesUploads.fileTitle}</span><br/>
                      <span>{presentationSlidesUploads.fileDescr}</span>
                    </div>
                  </div>
                  <div className="file_archives file_descr_margin_">
                    <span>{presentationSlidesUploads.archiveTitle}</span>
                  </div>
                  <div className="date_time file_descr_margin_">
                    <span>{presentationSlidesUploads.fileDate}</span><br/>
                    <span>{presentationSlidesUploads.fileTime}</span>
                  </div>
      ...
      <div className="pagination_container">
          <TablePagination
            ...
            component="div"
            count={presentationSlidesUpload.length}
            page={page}
