                  ...
                  <div className="file">
                    <div className="fileLogo">
                      <Image
                        width="45"
                        height="55"
                        src={documentsUploads.fileLogo}
                        alt="docxFileLogo"
                      />
                    </div>
                    <div className="file_desc">
                      <span>{documentsUploads.fileTitle}</span><br/>
                      <span>{documentsUploads.fileDescr}</span>
                    </div>
                  </div>
                  <div className="file_archives file_descr_margin_">
                    <span>{documentsUploads.archiveTitle}</span>
                  </div>
                  <div className="date_time file_descr_margin_">
                    <span>{documentsUploads.fileDate}</span><br/>
                    <span>{documentsUploads.fileTime}</span>
                  </div>
