...
export default function FileContents () {
  ...
  const emptyRows =
    rowsPerPage -
    Math.min (rowsPerPage, fileUpload.length - page * rowsPerPage);
                  ...
                  <div className="file">
                    <div className="fileLogo">
                      <Image
                        width="45"
                        height="55"
                        src={fileUploads.fileLogo}
                        alt="pdfFileLogo"
                      />
                    </div>
                    <div className="file_desc">
                      <span>{fileUploads.fileTitle}</span><br/>
                      <span>{fileUploads.fileDescr}</span>
                    </div>
                  </div>
                  <div className="file_archives file_descr_margin_">
                    <span>{fileUploads.archiveTitle}</span>
                  </div>
                  <div className="date_time file_descr_margin_">
                    <span>{fileUploads.fileDate}</span><br/>
                    <span>{fileUploads.fileTime}</span>
                  </div>
