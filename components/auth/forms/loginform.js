            ...
            <div className="social">
              ...
              >
                ...
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M17 15H33C34.1046 15 35 15.8954 35 17V33C35 34.1046 34.1046 35 33 35H17C15.8954 35 15 34.1046 15 33V17C15 15.8954 15.8954 15 17 15ZM17 17V33H33V17H17ZM24.1331 25.0044H26V31H28V25.0044H29.9824V23.0044H28V22C28 21.4477 28.4477 21 29 21H30V19H29C27.3431 19 26 20.3431 26 22V23.0044H24.1331V25.0044Z"
                  fill="white"
                />
              </svg>
              ...
              >
                ...
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M26 26V24H35V25C35 30.5228 30.5228 35 25 35C19.4772 35 15 30.5228 15 25C15 19.4772 19.4772 15 25 15C28.0799 15 30.9313 16.4025 32.8167 18.7626L31.2542 20.0109C29.7443 18.1209 27.4653 17 25 17C20.5817 17 17 20.5817 17 25C17 29.4183 20.5817 33 25 33C29.0796 33 32.446 29.9463 32.9381 26H26Z"
                  fill="white"
                />
              </svg>
